...
var wasmBinaryFile;
  wasmBinaryFile = 'pango-segmentation.wasm';
...
// end include: preamble.js
  ...
  var PThread = {unusedWorkers:[],runningWorkers:[],tlsInitFunctions:[],pthreads:{},nextWorkerID:1,debugInit:function() {
        ...
        var pthreadMainJs = locateFile('pango-segmentation.worker.js');
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(4, 1, path, mode);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(7, 1, fd, buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(9, 1, path, size, buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(8, 1, fd, size, buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(17, 1, fds, nfds, timeout);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(19, 1, olddirfd, oldpath, newdirfd, newpath);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(20, 1, path);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(21, 1, path, buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 1, target, linkpath);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(23, 1, dirfd, path, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(24, 1, len, prot, flags, fd, off, allocated, addr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(25, 1, addr, len, prot, flags, fd, offset);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(26, 1, which, timeout_ms);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(27, 1, __environ, environ_buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(28, 1, penviron_count, penviron_buf_size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(29, 1, fd);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(30, 1, fd, pbuf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(32, 1, fd, offset_low, offset_high, whence, newOffset);
...
var proxiedFunctionTable = [null,_proc_exit,exitOnMainThread,pthreadCreateProxied,___syscall_chmod,___syscall_faccessat,___syscall_fcntl64,___syscall_fstat64,___syscall_fstatfs64,___syscall_statfs64,___syscall_getcwd,___syscall_getdents64,___syscall_ioctl,___syscall_lstat64,___syscall_mkdirat,___syscall_newfstatat,___syscall_openat,___syscall_poll,___syscall_readlinkat,___syscall_renameat,___syscall_rmdir,___syscall_stat64,___syscall_symlink,___syscall_unlinkat,__mmap_js,__munmap_js,__setitimer_js,_environ_get,_environ_sizes_get,_fd_close,_fd_fdstat_get,_fd_read,_fd_seek,_fd_write];
...
var ___start_em_js = Module['___start_em_js'] = 943580;
var ___stop_em_js = Module['___stop_em_js'] = 956652;
